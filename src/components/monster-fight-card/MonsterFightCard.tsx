            ...
            <div className="monster-info">
                <div className="flex justify-around">
                    <div>
                        ...
                        <input className="ml-2" type="checkbox" name="" id="action" checked={monster.action} onChange={updateAction} disabled={monster.currentHitPoints === 0}/>
                    </div>
                    <div>
                        <label htmlFor="move"><FormattedMessage id="move"/></label>
                        <input className="ml-2" type="checkbox" name="" id="move" checked={monster.move} onChange={updateMove} disabled={monster.currentHitPoints === 0}/>
                        </div>
                    <div>
                        <label htmlFor="bonus-action"><FormattedMessage id="bonusAction"/></label>
                        <input className="ml-2" type="checkbox" name="" id="bonus-action" checked={monster.bonusAction} onChange={updateBonusAction} disabled={monster.currentHitPoints === 0}/>
                        </div>
                        </div>
