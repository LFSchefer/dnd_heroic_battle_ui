        ...
        <div className="initiative-card bg-blue-200 rounded-md border-2 border-neutral-800/10 p-4 my-2 text-left">
            ...
            <div className="my-2">
                <form noValidate className="flex item-center" onSubmit={handleSave}>
                    ...
                    <input id="d20" type="number" value={d20} onChange={handleChange} className="block rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-cyan-400 sm:text-sm/6 px-4 w-24 mx-4 bg-neutral-100"/>
                    ...
                    <input type="number" id="initiative" value={initiative} onChange={handleChange} className="block rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-cyan-400 sm:text-sm/6 px-4 w-24 mx-4 bg-neutral-100"/>
